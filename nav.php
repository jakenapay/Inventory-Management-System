                    ...
                    <ul class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="dropdown show">
                            <a class="btn btn-sm dropdown-toggle" href="" role="button" id="dropdownCart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="badge badge-warning" id='lblCartCount'><?php echo $totalIDs ?></span>
                            </a>
                        ...
                        <div class="dropdown">
                            ...
                            <!-- Image trigger -->
                            <div class="rounded-image" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
