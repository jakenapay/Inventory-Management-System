...
<body>
                    ...
                    <div class="row g-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-12 col-md-6 col-6">
                            <div class="nav-item nav-link d-flex justify-content-end">
                                <button type="button" id="addNewChapter" class="btn btn-success btnGreen btn-sm" data-toggle="modal" data-target="#chaptersModal">
    ...
    <div class="modal fade" id="chaptersModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="includes/chapters.inc.php" method="POST" enctype="multipart/form-data">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title font-weight-bold" id="chaptersModalLabel">New Chapter</h6>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="includes/chapters.inc.php" method="POST" enctype="multipart/form-data">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title font-weight-bold" id="chaptersModalLabel">Edit Chapter</h6>
